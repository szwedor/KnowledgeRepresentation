...
possibly executable  ({Bilbo, TakeSword},{Bilbo,AttakFrodo},{Frodo,AttackBilbo}) - true
...
possibly $\neg$BilboLives
 after ({Bilbo,TakeSword},{Bilbo,AttackFrodo},{Frodo,AttackBilbo}) from BilboLives and FrodoLives - true
\newpage
