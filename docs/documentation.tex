...
\begin{document}
    ...
    Wykonanie programu działań $((A_1, \omega_1),...,(A_n,\omega_n))$ z dowolnego stanu spełniającego  warunek $\gamma$ zawsze prowadzi do stanu spełniającego warunek $\pi$.
    
    \begin{center}
        $\mathbf{possibly}~\gamma~\mathbf{after}~((A_1, \omega_1),...,(A_n,\omega_n))~\mathbf{from}~\pi$
    \end{center}
    
    Wykonanie programu działań $((A_1, \omega_1),...,(A_n,\omega_n))$ z dowolnego stanu spełniającego  warunek $\gamma$ kiedykolwiek prowadzi do stanu spełniającego warunek $\pi$.
    ...
    Wykonanie dowolnego programu działań z dowolnego stanu spełniającego warunek $\gamma$ zawsze prowadzi do stanu spełniającego warunek $\pi$.
    
    \begin{center}
        $\mathbf{possibly}~\mathbf{accessible}~\gamma~\mathbf{from}~\pi$
    \end{center}
    
    Wykonanie dowolnego programu działań z dowolnego stanu spełniającego warunek $\gamma$ kiedykolwiek prowadzi do stanu spełniającego warunek $\pi$.
