...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item $\omega \in \mathcal{\omega}$ - agenci, w szczególności $\epsilon$ oznacza brak agenta (jakiegokolwiek agenta)
    ...
    \begin{itemize}
        ...
        \item $ResAb: \mathcal{A}c \times \mathcal{\omega} \times \Sigma \rightarrow \Sigma^2$ jest nietypową funkcją przejścia
        \item $ResN: \mathcal{A}c \times \mathcal{\omega} \times \Sigma \rightarrow \Sigma^2$ jest typową funkcją przejścia
    \end{itemize}
    \end{definition}
    ...
    Niech $Res = ResAb \cup ResN$, $\Psi_S: (\mathcal{A}c \times (\mathcal{\omega} \cup \{ \epsilon \}))^* \times \Sigma \rightarrow \Sigma^2$ będzie mapowaniem takim, że:
    \begin{itemize}
    ...
    \Psi_S(((A_1, \omega_1), ..., (A_n, \omega_n), \sigma) \in \left \{
        \begin{array}{ll}
             \bigcup\limits_{\omega \in \mathcal{\omega}} Res((A_n, \omega), \Psi_S((A_1, \omega_1), ..., (A_{1-n}, \omega_{1-n})),~jesli~\omega_n = \epsilon\\
    ...
    \begin{itemize}
        \item $New: \mathcal{A}c \times \mathcal{\omega} \times \Sigma \times \Sigma \rightarrow$ jest funkcją, która przypisuje każdej akcji $A \in \mathcal{A}c$, każdemu agentowi $\omega \in \mathcal{\omega}$ i wszystkim $\sigma, \sigma' \in \Sigma$ zbiór literałów $\bar{f}$ takich, że:
        \begin{itemize}
        ...
        \item $Res_0: \mathcal{A}c \times \mathcal{\omega} \times \Sigma \rightarrow \Sigma^2$ jest funkcją, która dla każdej akcji $A \in \mathcal{A}c$, każdego stanu $\sigma \in \Sigma$ i każdego agenta $\omega \in \mathcal{\omega}$ jest zbiorem wszystkich stanów $\sigma' \in \Sigma$ takich, że:\\
        ...
        \item $Res^-: \mathcal{A}c \times \mathcal{\omega} \times \Sigma \rightarrow \Sigma^2$ jest funkcją, która dla każdej akcji $A \in \mathcal{A}c$, każdego stanu $\sigma \in \Sigma$ i każdego agenta $\omega \in \mathcal{\omega}$ jest zbiorem wszystkich stanów $\sigma' \in \Sigma$ takich, że zbiory $New(A, \omega, \sigma, \sigma')$ są minimalne.
    ...
    \begin{itemize}
        ...
        \item dla każdej akcji $A \in \mathcal{A}c$, każdego stanu $\sigma \in \Sigma$ i każdego agenta $\omega \in \mathcal{\omega}$
